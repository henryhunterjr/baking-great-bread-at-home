      ...
      >
        <div className="container mx-auto px-4 flex justify-between items-center h-16 md:h-20">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <button onClick={() => handleNavigation("/recipe-converter")} className="nav-link flex items-center space-x-2 text-bread-800 dark:text-bread-300 hover:text-bread-600 dark:hover:text-bread-200">
              <Book size={18} />
              <span>Recipe Converter</span>
            </button>
            <button onClick={() => handleNavigation("/books")} className="nav-link flex items-center space-x-2 text-bread-800 dark:text-bread-300 hover:text-bread-600 dark:hover:text-bread-200">
              <Book size={18} />
